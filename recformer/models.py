...
class RecformerEmbeddings(nn.Module):
    ...
    def forward(self, input_ids=None, token_type_ids=None, item_position_ids=None):
...
class RecformerModel(LongformerPreTrainedModel):
    ...
    def _pad_to_window_size(
        ...
        # padding to n*attention_window length
        ...
        return padding_len, input_ids, attention_mask, token_type_ids, item_position_ids
    ...
    def forward(
        ...
        padding_len, input_ids, attention_mask, token_type_ids, item_position_ids = self._pad_to_window_size(
            input_ids=input_ids,
        ...
        embedding_output = self.embeddings(input_ids=input_ids, item_position_ids=item_position_ids, token_type_ids=token_type_ids)
